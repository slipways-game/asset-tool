    ...
    public static class TMP_EditorUtility
    {
        ...
        private static string GetPackageRelativePath()
        {
            ...
            if (Directory.Exists(packagePath))
            {
                ...
                // Vendored
                if (Directory.Exists(packagePath + "/Assets/Vendor/TextMesh Pro/Editor Resources"))
                {
                    return "Assets/Vendor/TextMesh Pro";
                }
        ...
        private static string GetPackageFullPath()
        {
            ...
            if (Directory.Exists(packagePath))
            {
                ...
                if (Directory.Exists(packagePath + "/Assets/Vendor/TextMesh Pro/Editor Resources"))
                {
                    return packagePath + "/Assets/Vendor/TextMesh Pro";
                }
